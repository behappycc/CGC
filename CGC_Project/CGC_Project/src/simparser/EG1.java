...
public class EG1 implements EG1Constants {
  ...
  final public boolean one_line() throws ParseException {
        boolean a, b;
  ...
  final public boolean result() throws ParseException {
        Token id;
        Token result;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ID:
      id = jj_consume_token(ID);
        if(project.getCondition(id.toString(), table_spec) == null){
                ...
                {if (true) return project.getCondition(id.toString(), table_spec).getResult().getValue();}
      break;
    case RESULT:
      result = jj_consume_token(RESULT);
                {if (true) return Result.BySymbol(result.toString()).getValue();}
      break;
    default:
      jj_la1[2] = jj_gen;
      jj_consume_token(-1);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x20,0x2041,0x2040,};
   }
